...
import {
  ...
  DropdownMenuTrigger
} from '@renderer/common/components/dropdown-menu'
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          type="button"
          className="flex w-full max-w-xs items-center justify-between gap-3 rounded border border-white/15 bg-black/35 px-3 py-2 text-left text-sm text-white transition-colors hover:bg-black/45"
        >
