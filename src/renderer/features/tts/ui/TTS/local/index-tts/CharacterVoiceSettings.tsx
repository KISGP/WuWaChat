...
import { downloadCharacterVoice, getCharacterVoiceStatus } from '@renderer/services/tts'
...
export function IndexTtsCharacterVoiceSettings({
  ...
  useEffect(() => {
    ...
    const loadStatus = async (): Promise<void> => {
      ...
      setError(null)
      try {
        const status = await getCharacterVoiceStatus(characterId)
  ...
  const handleDownload = async (): Promise<void> => {
    ...
    setError(null)
    try {
      const status = await downloadCharacterVoice(characterId)
