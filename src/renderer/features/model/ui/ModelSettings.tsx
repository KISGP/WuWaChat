...
import { useModelTabState } from '../hooks/useModelSettings'
import { selectActiveProfile, useSettingsStore } from '@renderer/store/profiles'
import { useShallow } from 'zustand/react/shallow'
import { ModelConnectionSection } from './ConnectionSection'
import { ModelProfileList } from './ProfileList'
import { ModelProviderField } from './ProviderField'
import { ModelSelectorField } from './SelectorField'
import { ModelAdvancedSection } from './AdvancedSection'
import { SectionCard } from '@renderer/common/components/SectionCard'
import { Input } from '@renderer/common/components/input'
import { ConfirmActionModal } from '@renderer/common/components/ConfirmActionModal'
          ...
          {currentProfile ? (
            <>
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-3">
                      <label className="flex flex-col gap-1.5">
                        ...
                        <Input
                          ...
                          onChange={(event) =>
                            updateCurrentProfile({ baseUrl: event.target.value })
                          }
                      ...
                      <label className="flex flex-col gap-1.5">
                        ...
                        <span className="relative">
                          <Input
                            ...
                            onChange={(event) =>
                              updateCurrentProfile({ apiKey: event.target.value })
                            }
              ...
              <ModelConnectionSection
                ...
                onCancel={handleCancelTestConnection}
              />
            </>
          ) : (
