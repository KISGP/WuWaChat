...
import ChatInputArea from '@renderer/components/chat-input-area'
import ChatMessagesList from '@renderer/components/chat-messages-list'

type AreaRightViewProps = {
...
export default function AreaRightView({
  activateChar,
  ...
  onStop,
  isLoading
}: AreaRightViewProps): ReactElement {
  return (
