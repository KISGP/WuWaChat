...
function BubbleGroup({ className, ...props }: React.ComponentProps<'div'>): React.ReactElement {
  return (
    <div
...
function BubbleTail({ className, ...props }: React.ComponentProps<'div'>): React.ReactElement {
  return (
    <div
...
const bubbleReactionsVariants = cva(
  'pointer-events-auto absolute z-20 flex w-fit shrink-0 items-center justify-center gap-1 rounded-full bg-muted px-1.5 py-0.5 text-sm ring-3 ring-card has-[button]:p-0',
  {
    variants: {
      side: {
...
export { BubbleGroup, Bubble, BubbleContent, BubbleTail, BubbleReactions }
